...
/**
 * Event called when a player uses mana by casting a skill
 */
public class PlayerManaUseEvent extends Event implements Cancellable {
     ...
     */
    public PlayerManaUseEvent(PlayerSkills playerData, int amount) {
